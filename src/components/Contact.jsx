            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                <div className='flex-1'>
                    ...
                    <div className='mb-4 mt-8'>
                        ...
                        <a href="mailto:sarvin.msg2006@gmail.com" className='hover:underline'>sarvin.msg2006@gmail.com</a>
                    </div>
                    <div className='mb-4'>
                        <FaPhone className='inline-block text-green-400 mr-2'></FaPhone>
                        <span>+9042251304</span>
                    </div>
                    <div className='mb-4'>
                        <FaMapMarkedAlt className='inline-block text-green-400 mr-2'></FaMapMarkedAlt>
                        <span>9/231, Pillayarkovil street, Alagammalpuram, Tenkasi, Tamilnadu, India, 627423</span>
                    </div>
                </div>
                <div className='flex-1 w-full'>
                    <form className='space-y-4'>
                        ...
                        <div>
                            <label htmlFor='merssage' className='block mb-2'>Message</label>
                            <textarea type="text" className='w-full p-2 rounded bg-gray-800 border border-gray-600 focus:outline-none
                            focus:border-green-400' placeholder='Enter Your Message' rows="5"/>
                        </div>
